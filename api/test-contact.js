...
function generateEmailHtml(prenom, nom, details, isClient) {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1 style="margin: 0; font-size: 24px; font-weight: normal;">Kreasyon Design</h1>
            </div>
            <div class="content">
                ...
                ${isClient ? `<p style="margin-top: 30px; font-size: 14px; color: #888;">Ceci est un message automatique, merci de ne pas y répondre directement.</p>` : ''}
            </div>
            <div class="footer">
